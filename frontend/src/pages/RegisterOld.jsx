...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.occupation) registrationData.occupation = formData.occupation;
      if (formData.annualIncome) registrationData.annualIncome = parseFloat(formData.annualIncome);
      ...
      if (formData.address.city || formData.address.state || formData.address.pincode) {
        ...
        if (formData.address.city) registrationData.address.city = formData.address.city;
        if (formData.address.state) registrationData.address.state = formData.address.state;
        if (formData.address.pincode) registrationData.address.pincode = formData.address.pincode;
      }
